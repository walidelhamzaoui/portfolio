        ...
        <div ref={userf} className="row d-flex justify-content-cente  ">
          <div className="col-lg-6 col-md-6  text-center text-lg-start text-md-start">
            <div className="tite lh-lg ">
              ...
              <p className=" me-3 pb-3 fs-5 text-black text-center text-lg-start  text-md-start   ">As a full stack developer, I possess a broad range of technical skills and knowledge that allow me to develop and maintain both<br/> the front-end and back-end of a web application.<br/> My expertise includes knowledge of various programming languages, databases, and frameworks, which enable me to create web applications that are not only functional but also scalable and robust.</p>
              <div ref={userfi} className="d-flex justify-content-center justify-content-lg-start ms-3 gap-4 mb-5 ">
