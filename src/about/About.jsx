...
return(
<div className="pt-5" style={{backgroundColor:"#C6D4FF"}}>
...
<div  ref={userfi} className="d-flex gap-4 mb-5 ps-5 ms-5 ms-md-0 ms-lg-0 text-lg-start  text-md-start">
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="50" fill="white" class="bi bi-facebook socialSvg" viewBox="0 0 16 16">
...
<div ref={userfb} className="text-lg-start  text-md-start  pb-5 text-center ">
<button className=" cv border-0 rounded-2 p-1  text-center " onClick={()=>downloadfileAtUr(PDF_FILE_Url)}><svg xmlns="http://www.w3.org/2000/svg" width="35" height="20" fill="currentColor" class="bi bi-cloud-arrow-up-fill" viewBox="0 0 16 16">
