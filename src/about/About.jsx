        ...
        <div ref={userf} className="row d-flex justify-content-cente  ">
          <div className="col-lg-6 col-md-6  text-center text-lg-start text-md-start">
            <div className="tite lh-lg ">
              ...
              <div ref={userfb} className=" text-lg-start  pb-5 text-center ">
                <button className=" cv  ms-lg-5 border-0 rounded-2 p-1  text-center " onClick={() => downloadfileAtUr(PDF_FILE_Url)}><svg xmlns="http://www.w3.org/2000/svg" width="35" height="20" fill="currentColor" className="bi bi-cloud-arrow-up-fill" viewBox="0 0 16 16">
